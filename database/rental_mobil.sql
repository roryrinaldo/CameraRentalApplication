...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 13, 2023 at 10:33 PM
...
INSERT INTO `booking` (`kode_booking`, `id_kamera`, `tgl_mulai`, `tgl_selesai`, `durasi`, `status`, `email`, `tgl_booking`, `bukti_bayar`) VALUES
('TRX00001', 2, '2023-08-15', '2023-08-16', 2, 'Selesai', 'rory@gmail.com', '2023-08-13', '13082023190935photo-1496307653780-42ee777d4833.jpg'),
('TRX00002', 2, '2023-08-16', '2023-08-16', 1, 'Menunggu Pembayaran', 'rory@gmail.com', '2023-08-14', '');
...
INSERT INTO `cek_booking` (`kode_booking`, `id_kamera`, `tgl_booking`, `status`) VALUES
('TRX00001', 2, '2023-08-15', 'Selesai'),
('TRX00001', 2, '2023-08-16', 'Selesai'),
('TRX00002', 2, '2023-08-16', 'Menunggu Pembayaran');
...
(1, 'Gudang Kamera Pekanbaru', 'gudangkamerapku@gmail.com', '08126146957');
...
CREATE TABLE `kamera` (
  `id_kamera` int(11) NOT NULL,
  `nama_kamera` varchar(150) DEFAULT NULL,
...
INSERT INTO `kamera` (`id_kamera`, `nama_kamera`, `id_merek`, `kategori`, `deskripsi`, `harga_jual`, `harga_sewa`, `tipe`, `tahun`, `image1`, `image2`, `image3`, `image4`, `image5`, `RegDate`, `UpdationDate`) VALUES
(1, 'Canon EOS 80D', 2, 'Baru', 'Canon EOS 80D. Kamera ini pun memiliki tipe sensor CMOS dengan ukuran 22.5 x 15mm serta layar dengan ukuran 3\". Video pada kamera ini beresolusi Full HD dengan minimum ISO 100 dan maksimal ISO 16000.', 6100000, 0, 'DSLR', 2023, 'uploaded_aea654bef560d7f739e3b8a565a9a70d.jpg', 'uploaded_e6fc3b3fb07ac02c2fe8dcabe71815cb.jpg', 'uploaded_6f7decf8c32f498740356ab85eeb8ccb.jpg', 'uploaded_9ebd818b19f0e40114c1ab71038d3f47.jpg', '', '2023-08-13 08:37:13', '2023-08-13 08:55:12'),
(2, 'Canon EOS M50', 2, 'Bekas', 'Canon EOS M50 merupakan kamera mirrorless Canon dengan ketajaman video Full HD. Didukung dengan ISO sebesar 100-12800, mirrorless Canon EOS M50 ini dilengkapi pula dengan viewfinder Elektronik dan sensor CMOS APS-C. Rilis tahun: 2018.', 2500000, 100000, 'Mirrorless', 2023, 'uploaded_f8926828c7dcf7f566e6b9ec251bfd35.jpg', 'uploaded_81b99dcc87189b4fb3890b31263610d1.jpg', 'uploaded_f8926828c7dcf7f566e6b9ec251bfd35.jpg', 'uploaded_81b99dcc87189b4fb3890b31263610d1.jpg', '', '2023-08-13 08:40:14', NULL);
...
(1, 'Sony', '2023-08-11 19:35:25', NULL),
(2, 'Canon', '2023-08-11 19:35:30', NULL),
(3, 'Fujifilm', '2023-08-11 19:35:46', NULL),
(4, 'Samsung', '2023-08-11 19:35:54', NULL);
...
INSERT INTO `penjualan` (`id_penjualan`, `id_kamera`, `email`, `tanggal_pesan`, `harga`, `status`) VALUES
(1, 2, 'rory@gmail.com', '2023-08-13', 6000000, 'Diterima');
...
INSERT INTO `reminder` (`id_reminder`, `kode_booking`, `email`, `tanggal_pengingat`) VALUES
(1, 'TRX00001', 'rory@gmail.com', '2023-08-14');
...
(8, 'Rory', 'rory@gmail.com', '6c27ea029ce5894cf6c66690bbe6acde', '08228578528', 'Jl. Ahmad Yani Simpang Tiga', '07082023162058dasd.png', '07082023162058dasd.png', '2023-08-07 14:20:58', NULL),
(10, 'user', 'user@gmail.com', 'ee11cbb19052e40b07aac0ca060c23ee', '02888888888', 'asdsadasd', '13082023220958wallpaperflare.com_wallpaper.jpg', '13082023220958wallpaperflare.com_wallpaper.jpg', '2023-08-13 20:09:58', NULL);
...
--
ALTER TABLE `kamera`
  MODIFY `id_kamera` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
ALTER TABLE `reminder`
  MODIFY `id_reminder` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
