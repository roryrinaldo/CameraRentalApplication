<nav class="ts-sidebar">
    <ul class="ts-sidebar-menu">			
        ...
        <li><a href="data_pembelian.php"><i class="fa fa-shopping-cart"></i>Penjualan</a></li>
        <li><a href="#"><i class="fa fa-camera"></i> Kamera</a>
            <ul class="ts-sidebar-menu">
                <li><a href="merek.php">Data Merek</a></li>				  						
                <li><a href="kamera.php">Data Kamera</a></li>
            </ul>
        </li>
