...
<head>
	...
	<title>Gudang Kamera | Admin Dashboard</title>
									...
									<div class="col-md-4">
										<div class="panel panel-default">
											<div class="panel-body bk-success text-light">
												<div class="stat-panel text-center">
												<?php 
												$sql1 = "SELECT id_kamera FROM kamera";
												$query1 = mysqli_query($koneksidb,$sql1);
												$totalkamera=mysqli_num_rows($query1);
												?>
													<div class="stat-panel-number h1 "><?php echo htmlentities($totalkamera);?></div>
													<div class="stat-panel-title text-uppercase">Jumlah Kamera</div>
												</div>
											</div>
											<a href="kamera.php" class="block-anchor panel-footer text-center">Rincian &nbsp; <i class="fa fa-arrow-right"></i></a>
										</div>
									</div>
									...
									<div class="col-md-4">
										<div class="panel panel-default">
											<div class="panel-body bk-primary text-light">
												<div class="stat-panel text-center">
												<?php 
												$sql6 = "SELECT id_penjualan FROM penjualan";
												$query6 = mysqli_query($koneksidb,$sql6);
												$query=mysqli_num_rows($query6);
												?>
													<div class="stat-panel-number h1 "><?php echo htmlentities($query);?></div>
													<div class="stat-panel-title text-uppercase">Penjualan</div>
												</div>
											</div>
											<a href="data_pembelian.php" class="block-anchor panel-footer text-center">Rincian &nbsp; <i class="fa fa-arrow-right"></i></a>
										</div>
									</div>
								</div>
							</div>
