...
header('location:index.php');
	...
	if(isset($_POST['submit'])){
		...
		$mySql2	= "INSERT INTO reminder (kode_booking,email,tanggal_pengingat) VALUES ('$kode','$email','$tanggal_pengingat')";
		$myQrye	= mysqli_query($koneksidb, $mySql2);
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Pengembalian Kamera</h2>
							...
							<div class="col-md-12">
								<div class="panel panel-default">
									...
									<div class="panel-body">
										<?php 
										$id=$_GET['id'];
										$sqlsewa = "SELECT booking.*,kamera.*,merek.*,users.* FROM booking,kamera,merek,users WHERE booking.id_kamera=kamera.id_kamera
													AND merek.id_merek=kamera.id_merek AND users.email=booking.email AND booking.kode_booking ='$id'";
										$querysewa = mysqli_query($koneksidb,$sqlsewa);
										$result = mysqli_fetch_array($querysewa);
										$biayamobil=$result['durasi']*$result['harga-sewa'];
										$total = $biayamobil;
										?>
									...
									<div class="panel-heading">Detail Sewa</div>
										...
										<form>
											<div class="form-group">
												...
												<div class="col-sm-4">
													<input type="text" name="namamobil" class="form-control" value="<?php echo $result['nama_kamera'];?>" required readonly>
												</div>
											</div>
