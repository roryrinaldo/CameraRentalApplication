...
if($_GET) {
	...
	$sqlsewa = "SELECT booking.*,kamera.*,merek.*,users.* FROM booking,kamera,merek,users WHERE booking.id_kamera=kamera.id_kamera
				AND merek.id_merek=kamera.id_merek AND users.email=booking.email AND booking.kode_booking='$Kode'";
...
<table width="100%">
	...
	<tr>
		<td width="20%"><b>Kamera</b></td>
		<td width="2%"><b>:</b></td>
		<td width="78%"><?php echo $result['nama_merek'];?>, <?php echo $result['nama_kamera'];?></td>
	</tr>
	<tr>
		<td colspan="3">&nbsp;</td>
	</tr>
