...
$sqlsewa = "SELECT booking.*,kamera.*,merek.*,users.* FROM booking,kamera,merek,users WHERE booking.id_kamera=kamera.id_kamera
			AND merek.id_merek=kamera.id_merek AND users.email=booking.email AND booking.status='Selesai' 
				...
				<tbody>
					<tr>
						<td rowspan="3" width="16%" class="text-center">
							<img src="../assets/images/logo11fix.png" alt="logo" width="80" />
						</td>
						<td class="text-center"><h3>Sewa Kamera</h3></td>
						<td rowspan="3" width="16%">&nbsp;</td>
					</tr>
					<tr>
						<td class="text-center"><h2>Gudang Kamera Pekanbaru </h2></td>
					</tr>
					<tr>
						<td class="text-center">Jl. Kayangan No.70a, Meranti Pandak, Kec. Rumbai Pesisir, Kota Pekanbaru, Riau 28266</td>
					</tr>
				</tbody>
			</table>
			<hr class="line-top" />
