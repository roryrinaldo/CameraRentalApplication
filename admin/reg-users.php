...
<head>
	...
	<title>Sewa Kamera | Admin Kelola User</title>
									...
									?>	
										<tr>
											...
											<td>
												...
												<a href="userdel.php?email=<?php echo $result['email'];?>" onclick="return confirm('Apakah anda yakin akan menghapus akun <?php echo $result['email'];?>?');"><i class="fa fa-remove"></i></a>
											</td>
										</tr>
										<?php } ?>
