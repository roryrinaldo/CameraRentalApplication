...
$sql1 	= "SELECT booking.*,kamera.*, merek.*, users.* FROM booking,kamera,merek,users WHERE booking.id_kamera=kamera.id_kamera 
			AND merek.id_merek=kamera.id_merek and booking.email=users.email and booking.kode_booking='$kode'";
			...
			<table class="table table-borderless">
				<tbody>
					<tr>
						...
						<td class="text-center"><h3>Gudang Kamera Pekanbaru </h3></td>
						<td rowspan="3" width="16%">&nbsp;</td>
					</tr>
					<tr>
						<td class="text-center"><h2>Sewa Kamera</h2></td>
					</tr>
					<tr>
			...
			<table class="table table-borderless">
				<tbody>
					...
					<tr>
						<td>Kamera</td>
						<td>:</td>
						<td><?php echo $result['nama_merek'];echo  ", "; echo $result['nama_kamera']; ?></td>
					</tr>
					<tr>
						<td>Tanggal Mulai</td>
						<td>:</td>
