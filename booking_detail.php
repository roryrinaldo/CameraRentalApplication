...
<body>
	...
	<?php 
		$kode=$_GET['kode'];
		$sql1 	= "SELECT booking.*,kamera.*, merek.* FROM booking,kamera,merek WHERE booking.id_kamera=kamera.id_kamera AND merek.id_merek=kamera.id_merek and booking.kode_booking='$kode'";
			...
			<div class="user_profile_info">	
				<div class="col-md-12 col-sm-10">
					<form method="post" name="sewa" onSubmit="return valid();"> 
						...
						<div class="form-group">
						<label>Kamera</label>
							<input type="text" class="form-control" name="mobil" value="<?php echo $result['nama_merek']; echo ", "; echo $result['nama_kamera'];?>"readonly>
						</div>
						<div class="form-group">
